        ...
        IEnumerator AnimateVertexColors()
        {
            ...
            while (true)
            {
                ...
                for (int i = 0; i < lineCount; i++)
                {
                    ...
                    Quaternion rotation = Quaternion.Euler(0, 0, RunRNG.Range(-0.25f, 0.25f) * RotationMultiplier);
                    ...
                    for (int j = first; j <= last; j++)
                    {
                        ...
                        float randomScale = RunRNG.Range(0.995f - 0.001f * ScaleMultiplier, 1.005f + 0.001f * ScaleMultiplier);
